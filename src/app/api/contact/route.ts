...
export async function POST(req: NextRequest) {
    try {
        ...
        const { name, email, subject, projectType, budget, message, honeypot } = result.data;
        ...
        <div style="font-family: sans-serif; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr><td style="padding: 10px; border: 1px solid #eee;"><strong>Budget</strong></td><td style="padding: 10px; border: 1px solid #eee;">${budget || "Not specified"}</td></tr>
